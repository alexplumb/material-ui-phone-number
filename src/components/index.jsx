...
const PREFIX = "MATERIAL_UI_PHONE_INPUT";
const classes = {
  flagButton: `${PREFIX}_FLAG_BUTTON`,
  native: `${PREFIX}_NATIVE`,
  nativeRoot: `${PREFIX}_NATIVE_ROOT`,
  nativeSelect: `${PREFIX}_NATIVE_SELECT`,
  positionStart: `${PREFIX}_POSITION_START`,
};
...
export default styled(MaterialUiPhoneNumber)(styles);
